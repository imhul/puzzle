jQuery(document).ready(function($) {
    ...
    $('#easy').on('click touchend', function() {
      PUZZLE_DIFFICULTY = 4;
      game.TOTAL_SECONDS = 30;
      level.innerText = 'Easy';
    });

    $('#normal').on('click touchend', function() {
      PUZZLE_DIFFICULTY = 5;
      game.TOTAL_SECONDS = 60;
      level.innerText = 'Normal';
    });

    $('#hard').on('click touchend', function() {
      PUZZLE_DIFFICULTY = 6;
      game.TOTAL_SECONDS = 90;
    ...
    function shufflePuzzle() {
        ...
        for (i = 0; i < _pieces.length; i++) {
            ...
            _stage.translate(xPos, yPos); // TODO Тут должна быть анимация пазлов
        ...
        // window.requestAnimationFrame(shufflePuzzle);
    }
