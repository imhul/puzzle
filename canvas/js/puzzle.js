...
(function(global) {
    ...
    global.nativeRAF = !!global.requestAnimationFrame;
...
jQuery(document).ready(function($) {
    ...
    var game = {
        ...
        play: function() {
            ...
            if (this.isStarted && !this.isPlaying) {
                ...
                // Если в процессе игры нажать stop, пазлы не должны перетаскиваться!
                // new game
                this.isStarted = true;
                this.isPlaying = true;
    ...
    $('#play .play').on('click touchend', function(e) {
        e.preventDefault();
    ...
    $('#stop .stop').on('click touchend', game.stopOrPause.bind(game));
    $('#reload .reload').on('click touchend', game.reset.bind(game));
